...
#include <vector>
#include "RevoDSPKernel.hpp"
#include "RevoBufferedAudioBus.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(RevoDSPKernel& kernel, BufferedInputBus& bufferedInputBus)
    : mKernel{kernel},
